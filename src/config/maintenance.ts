...
// Optional: Set estimated completion date
export const ESTIMATED_COMPLETION = "Coming Soon!";

// Optional: Set progress percentage
export const PROGRESS_PERCENTAGE = 75;
